...
import fetch from "node-fetch"; // node-fetch module is a third party module and it is used to make the http requests in nodejs
...
app.get("/nginx", async (req, res) => {
  try {
    ...
    console.error("Error occurred while fetching data from Nginx:", error);
    res.status(500).send("Internal Server Error");
  }
});
